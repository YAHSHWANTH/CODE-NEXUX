...
const Careers = () => {
  ...
  const handleSignup = async (e) => {
    ...
    try {
      ...
      setErrorMsg("Error signing up. Check backend logs.");
    }
  };
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      setErrorMsg("Error logging in. Check backend logs.");
    }
  };
                ...
                <form className="space-y-5" onSubmit={handleSignup}>
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className={`px-4 py-2 rounded-lg font-medium transition ${email && !otpSent && !loadingOtp
                  ...
                  <button
                    type="submit"
                    disabled={!isVerified}
                    className={`w-full py-3 rounded-lg font-semibold text-lg transition ${isVerified
                        ? "bg-purple-600 text-white hover:bg-purple-700"
